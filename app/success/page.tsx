            ...
            <div className="container mx-auto px-4 py-12 relative z-10">
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    >
                        ...
                        {/* Poster Preview */}
                        <div className="relative w-full aspect-[1200/630] rounded-xl overflow-hidden border border-emerald-500/30 mb-6 bg-[#064e3b]">
                            <img
                                src={posterUrl}
                                alt="Share Poster"
                        ...
                        <a
                            ...
                            target="_blank"
                            className="flex items-center justify-center gap-2 w-full py-3 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white font-bold rounded-xl mb-6 hover:from-emerald-500 hover:to-emerald-600 transition-all shadow-lg shadow-emerald-500/20"
                        >
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                            ...
                            <button
                                ...
                                className="flex items-center justify-center gap-2 bg-black hover:bg-gray-800 text-white py-3 rounded-xl font-semibold transition-all hover:scale-105"
                            >
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <button
                                ...
                                className="flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#128C7E] text-white py-3 rounded-xl font-semibold transition-all hover:scale-105"
                            >
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <button
                            ...
                            className="flex items-center justify-center gap-2 w-full mt-4 bg-gray-700 hover:bg-gray-600 text-white py-3 rounded-xl font-semibold transition-all"
                        >
