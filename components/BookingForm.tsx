                            ...
                            <div className="space-y-2 pt-2">
                                ...
                                <div className="flex items-center gap-4 flex-wrap">
                                    {photoUrl ? (
                                        ...
                                        <div className="w-16 h-16 rounded-full bg-white/5 border border-dashed border-white/20 flex items-center justify-center shrink-0">
                                            <Upload className="w-6 h-6 opacity-50" />
                                        </div>
                                    )}
                                    <Input type="file" accept="image/*" onChange={handleFileUpload} className="flex-1 min-w-0 cursor-pointer file:cursor-pointer" />
                                </div>
